$(document).ready(function () {
    /* ===================================
     Loading Timeout - REMOVED
     ====================================== */

    // Removed loader code to skip loading animation completely

    // Ensure elements are initially hidden
    $('#slide-67-layer-2, #slide-67-layer-3, #slide-67-layer-7').css('opacity', '0');
    
    // Slight delay before starting animations to ensure everything is loaded
    setTimeout(function() {
        // Main title with scale in effect
        $('#slide-67-layer-2').addClass('animated scaleIn');
        
        // Stagger the animations
        setTimeout(function() {
            // Subtitle with blur in effect
            $('#slide-67-layer-3').addClass('animated blurIn');
        }, 300);
        
        setTimeout(function() {
            // Button with fade in effect
            $('#slide-67-layer-7').addClass('animated fadeInSoft');
        }, 600);
    }, 100);
    ...
    $(window).scroll(function() {
        ...
        $('.parallax-hero .rev-slidebg').css('transform', 'translate3d(0, ' + scrollTop * 0.2 + 'px, 0) scale(1.1)');
    });
});
...
//check for browser os
    ...
    $('[data-fancybox]').fancybox({
        ...
        baseClass: 'fancybox-video-container',
    ...
    jQuery(document).ready(function($) {
        // Add reveal classes to elements
        $('.service-box').addClass('reveal from-bottom');
        $('.area-heading').addClass('reveal from-bottom');
        $('.team-quote').addClass('reveal from-left');
        $('.c-progress').addClass('reveal from-right');
